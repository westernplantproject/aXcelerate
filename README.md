# 📇 Contact List Component Library
...
Each component is:
a# 📇 Contact List Component Library
...
Repository: [https://github.com/westernplantproject/aXcelerate](https://github.com/westernplantproject/aXcelerate)
...
```bash
git clone https://github.com/westernplantproject/aXcelerate.git
cd aXcelerate
```
